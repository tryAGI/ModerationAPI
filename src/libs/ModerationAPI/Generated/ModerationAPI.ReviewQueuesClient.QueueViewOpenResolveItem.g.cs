...
namespace ModerationAPI
{
    public partial class ReviewQueuesClient
    {
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_QueueViewOpenResolveItemSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_QueueViewOpenResolveItemSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_QueueViewOpenResolveItemSecurityRequirement0,
            };
        partial void PrepareQueueViewOpenResolveItemArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string itemId,
            global::ModerationAPI.QueueViewOpenResolveItemRequest request);
        partial void PrepareQueueViewOpenResolveItemRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string itemId,
            global::ModerationAPI.QueueViewOpenResolveItemRequest request);
        partial void ProcessQueueViewOpenResolveItemResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueueViewOpenResolveItemResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await QueueViewOpenResolveItemAsResponseAsync(
                id: id,
                itemId: itemId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareQueueViewOpenResolveItemArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueueViewOpenResolveItemSecurityRequirements,
                operationName: "QueueViewOpenResolveItemAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQueueViewOpenResolveItemRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QueueViewOpenResolveItem",
                                methodName: "QueueViewOpenResolveItemAsync",
                                pathTemplate: "$\"/queue/{id}/items/{itemId}/resolve\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQueueViewOpenResolveItemResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueueViewOpenResolveItemResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModerationAPI.QueueViewOpenResolveItemResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.QueueViewOpenResolveItemResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModerationAPI.QueueViewOpenResolveItemResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await QueueViewOpenResolveItemAsync(
                id: id,
                itemId: itemId,
                request: __request,
                requestOptions: requestOptions,
