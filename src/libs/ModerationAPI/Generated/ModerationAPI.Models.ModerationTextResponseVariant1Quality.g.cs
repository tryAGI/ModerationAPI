...
namespace ModerationAPI
{
    ...
    public sealed partial class ModerationTextResponseVariant1Quality
    {
        ...
        public global::ModerationAPI.ModerationTextResponseVariant1QualityLabelScores? LabelScores { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModerationTextResponseVariant1Quality" /> class.
        /// </summary>
        /// <param name="label">
        /// The label of the model
        /// </param>
...
#endif
        public ModerationTextResponseVariant1Quality(
            string? label,
            double? score,
            string? error,
            string? warning,
            global::ModerationAPI.ModerationTextResponseVariant1QualityLabelScores? labelScores)
        {
            this.Label = label;
            this.Score = score;
            this.Error = error;
