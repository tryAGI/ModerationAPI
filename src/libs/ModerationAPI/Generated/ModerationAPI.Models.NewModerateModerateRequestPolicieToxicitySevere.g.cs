...
namespace ModerationAPI
{
    ...
    public sealed partial class NewModerateModerateRequestPolicieToxicitySevere
    {
        ...
        /// <summary>
        /// Creates a new <see cref="NewModerateModerateRequestPolicieToxicitySevere"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static NewModerateModerateRequestPolicieToxicitySevere FromFlag(bool flag)
        {
            return new NewModerateModerateRequestPolicieToxicitySevere
            {
                Flag = flag,
            };
        }
