...
namespace ModerationAPI
{
    ...
    public sealed partial class ModerationTextResponseVariant1Propriety
    {
        ...
        public global::ModerationAPI.ModerationTextResponseVariant1ProprietyLabelScores? LabelScores { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModerationTextResponseVariant1Propriety" /> class.
        /// </summary>
        /// <param name="label">
        /// The label of the model
        /// </param>
...
#endif
        public ModerationTextResponseVariant1Propriety(
            string? label,
            double? score,
            string? error,
            string? warning,
            global::ModerationAPI.ModerationTextResponseVariant1ProprietyLabelScores? labelScores)
        {
            this.Label = label;
            this.Score = score;
            this.Error = error;
