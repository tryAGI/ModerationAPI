...
namespace ModerationAPI
{
    ...
    public sealed partial class NewModerateModerateRequestPolicieAdult
    {
        ...
        /// <summary>
        /// Creates a new <see cref="NewModerateModerateRequestPolicieAdult"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static NewModerateModerateRequestPolicieAdult FromFlag(bool flag)
        {
            return new NewModerateModerateRequestPolicieAdult
            {
                Flag = flag,
            };
        }
