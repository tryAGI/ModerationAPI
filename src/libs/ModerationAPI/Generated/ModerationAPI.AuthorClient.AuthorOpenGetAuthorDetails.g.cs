...
namespace ModerationAPI
{
    public partial class AuthorClient
    {
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_AuthorOpenGetAuthorDetailsSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_AuthorOpenGetAuthorDetailsSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_AuthorOpenGetAuthorDetailsSecurityRequirement0,
            };
        partial void PrepareAuthorOpenGetAuthorDetailsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareAuthorOpenGetAuthorDetailsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessAuthorOpenGetAuthorDetailsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAuthorOpenGetAuthorDetailsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await AuthorOpenGetAuthorDetailsAsResponseAsync(
                id: id,
        ...
        /// console.log(author.id);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.PublicAuthor>> AuthorOpenGetAuthorDetailsAsResponseAsync(
            string id,
            global::ModerationAPI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAuthorOpenGetAuthorDetailsArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthorOpenGetAuthorDetailsSecurityRequirements,
                operationName: "AuthorOpenGetAuthorDetailsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthorOpenGetAuthorDetailsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthorOpenGetAuthorDetails",
                                methodName: "AuthorOpenGetAuthorDetailsAsync",
                                pathTemplate: "$\"/authors/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthorOpenGetAuthorDetailsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAuthorOpenGetAuthorDetailsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModerationAPI.PublicAuthor.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.PublicAuthor>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModerationAPI.PublicAuthor.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
