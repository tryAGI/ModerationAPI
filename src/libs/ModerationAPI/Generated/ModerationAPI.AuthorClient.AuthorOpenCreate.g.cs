...
namespace ModerationAPI
{
    public partial class AuthorClient
    {
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_AuthorOpenCreateSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_AuthorOpenCreateSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_AuthorOpenCreateSecurityRequirement0,
            };
        partial void PrepareAuthorOpenCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::ModerationAPI.AuthorOpenCreateRequest request);
        partial void PrepareAuthorOpenCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ModerationAPI.AuthorOpenCreateRequest request);
        partial void ProcessAuthorOpenCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAuthorOpenCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await AuthorOpenCreateAsResponseAsync(
        ...
        /// Console.WriteLine(author);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.PublicAuthor>> AuthorOpenCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAuthorOpenCreateArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthorOpenCreateSecurityRequirements,
                operationName: "AuthorOpenCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthorOpenCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthorOpenCreate",
                                methodName: "AuthorOpenCreateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthorOpenCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAuthorOpenCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AuthorOpenCreateAsync(
                request: __request,
                requestOptions: requestOptions,
