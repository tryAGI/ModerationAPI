...
{
    /// <inheritdoc />
    public sealed class PublicQueueItemMetaType2NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ModerationAPI.PublicQueueItemMetaType2?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::ModerationAPI.PublicQueueItemMetaType2Extensions.ToValueString(value.Value));
            }
        }
    }
}
