...
namespace ModerationAPI
{
    public partial class ReviewQueuesClient
    {
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_QueueViewOpenGetQueueSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_QueueViewOpenGetQueueSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_QueueViewOpenGetQueueSecurityRequirement0,
            };
        partial void PrepareQueueViewOpenGetQueueArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareQueueViewOpenGetQueueRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessQueueViewOpenGetQueueResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueueViewOpenGetQueueResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await QueueViewOpenGetQueueAsResponseAsync(
                id: id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareQueueViewOpenGetQueueArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueueViewOpenGetQueueSecurityRequirements,
                operationName: "QueueViewOpenGetQueueAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQueueViewOpenGetQueueRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QueueViewOpenGetQueue",
                                methodName: "QueueViewOpenGetQueueAsync",
                                pathTemplate: "$\"/queue/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQueueViewOpenGetQueueResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueueViewOpenGetQueueResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModerationAPI.QueueViewOpenGetQueueResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.QueueViewOpenGetQueueResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModerationAPI.QueueViewOpenGetQueueResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
