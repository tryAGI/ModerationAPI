...
namespace ModerationAPI
{
    ...
    public sealed partial class ModerationTextResponseVariant1Sentiment
    {
        ...
        public global::ModerationAPI.ModerationTextResponseVariant1SentimentLabelScores? LabelScores { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModerationTextResponseVariant1Sentiment" /> class.
        /// </summary>
        /// <param name="label">
        /// The label of the model
        /// </param>
...
#endif
        public ModerationTextResponseVariant1Sentiment(
            string? label,
            double? score,
            string? error,
            string? warning,
            global::ModerationAPI.ModerationTextResponseVariant1SentimentLabelScores? labelScores)
        {
            this.Label = label;
            this.Score = score;
            this.Error = error;
