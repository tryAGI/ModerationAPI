...
namespace ModerationAPI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::ModerationAPI.AutoSDKRetryOptions Retry { get; set; } = new global::ModerationAPI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::ModerationAPI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::ModerationAPI.IAutoSDKHook>();
        ...
        public global::ModerationAPI.AutoSDKClientOptions AddHook(
            global::ModerationAPI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::ModerationAPI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::ModerationAPI.AutoSDKClientOptions UseAuthorizationProvider(
            global::ModerationAPI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::ModerationAPI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::ModerationAPI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::ModerationAPI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::ModerationAPI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::ModerationAPI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::ModerationAPI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::ModerationAPI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::ModerationAPI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::ModerationAPI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::ModerationAPI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::ModerationAPI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::ModerationAPI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::ModerationAPI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::ModerationAPI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::ModerationAPI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::ModerationAPI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::ModerationAPI.AutoSDKClientOptions clientOptions,
            global::ModerationAPI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::ModerationAPI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::ModerationAPI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::ModerationAPI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::ModerationAPI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::ModerationAPI.IAutoSDKHook, global::ModerationAPI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::ModerationAPI.AutoSDKHookContext context)
        {
