...
{
    public partial class WordlistClient
    {


        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_WordlistWordlistEmbeddingStatusSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_WordlistWordlistEmbeddingStatusSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_WordlistWordlistEmbeddingStatusSecurityRequirement0,
            };
        partial void PrepareWordlistWordlistEmbeddingStatusArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareWordlistWordlistEmbeddingStatusRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessWordlistWordlistEmbeddingStatusResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWordlistWordlistEmbeddingStatusResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::ModerationAPI.WordlistWordlistEmbeddingStatusResponse> WordlistWordlistEmbeddingStatusAsync(
            string id,
            global::ModerationAPI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WordlistWordlistEmbeddingStatusAsResponseAsync(
                id: id,
        ...
        /// console.log(response.progress);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.WordlistWordlistEmbeddingStatusResponse>> WordlistWordlistEmbeddingStatusAsResponseAsync(
            string id,
            global::ModerationAPI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWordlistWordlistEmbeddingStatusArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WordlistWordlistEmbeddingStatusSecurityRequirements,
                operationName: "WordlistWordlistEmbeddingStatusAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWordlistWordlistEmbeddingStatusRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WordlistWordlistEmbeddingStatus",
                                methodName: "WordlistWordlistEmbeddingStatusAsync",
                                pathTemplate: "$\"/wordlist/{id}/embedding-status\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWordlistWordlistEmbeddingStatusResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWordlistWordlistEmbeddingStatusResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModerationAPI.WordlistWordlistEmbeddingStatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.WordlistWordlistEmbeddingStatusResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModerationAPI.WordlistWordlistEmbeddingStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
