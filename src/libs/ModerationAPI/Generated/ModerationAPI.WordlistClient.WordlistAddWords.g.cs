...
namespace ModerationAPI
{
    public partial class WordlistClient
    {
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_WordlistAddWordsSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_WordlistAddWordsSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_WordlistAddWordsSecurityRequirement0,
            };
        partial void PrepareWordlistAddWordsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::ModerationAPI.WordlistAddWordsRequest request);
        partial void PrepareWordlistAddWordsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::ModerationAPI.WordlistAddWordsRequest request);
        partial void ProcessWordlistAddWordsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWordlistAddWordsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::ModerationAPI.WordlistAddWordsResponse> WordlistAddWordsAsync(
            string id,
        ...
        {
            var __response = await WordlistAddWordsAsResponseAsync(
                id: id,
        ...
        /// console.log(response.addedCount);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.WordlistAddWordsResponse>> WordlistAddWordsAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareWordlistAddWordsArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WordlistAddWordsSecurityRequirements,
                operationName: "WordlistAddWordsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWordlistAddWordsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WordlistAddWords",
                                methodName: "WordlistAddWordsAsync",
                                pathTemplate: "$\"/wordlist/{id}/words\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWordlistAddWordsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWordlistAddWordsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModerationAPI.WordlistAddWordsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.WordlistAddWordsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModerationAPI.WordlistAddWordsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await WordlistAddWordsAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
