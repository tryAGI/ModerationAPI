...
namespace ModerationAPI
{
    public partial class WordlistClient
    {
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_WordlistGetWordlistPublicSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_WordlistGetWordlistPublicSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_WordlistGetWordlistPublicSecurityRequirement0,
            };
        partial void PrepareWordlistGetWordlistPublicArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareWordlistGetWordlistPublicRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessWordlistGetWordlistPublicResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWordlistGetWordlistPublicResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await WordlistGetWordlistPublicAsResponseAsync(
                id: id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWordlistGetWordlistPublicArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WordlistGetWordlistPublicSecurityRequirements,
                operationName: "WordlistGetWordlistPublicAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWordlistGetWordlistPublicRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WordlistGetWordlistPublic",
                                methodName: "WordlistGetWordlistPublicAsync",
                                pathTemplate: "$\"/wordlist/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWordlistGetWordlistPublicResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWordlistGetWordlistPublicResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModerationAPI.WordlistGetWordlistPublicResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.WordlistGetWordlistPublicResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModerationAPI.WordlistGetWordlistPublicResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
