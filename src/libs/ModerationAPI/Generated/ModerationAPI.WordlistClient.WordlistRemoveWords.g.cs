...
namespace ModerationAPI
{
    public partial class WordlistClient
    {
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_WordlistRemoveWordsSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_WordlistRemoveWordsSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_WordlistRemoveWordsSecurityRequirement0,
            };
        partial void PrepareWordlistRemoveWordsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::System.Collections.Generic.IList<string> words);
        partial void PrepareWordlistRemoveWordsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::System.Collections.Generic.IList<string> words);
        partial void ProcessWordlistRemoveWordsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWordlistRemoveWordsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await WordlistRemoveWordsAsResponseAsync(
                id: id,
                words: words,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWordlistRemoveWordsArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WordlistRemoveWordsSecurityRequirements,
                operationName: "WordlistRemoveWordsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWordlistRemoveWordsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WordlistRemoveWords",
                                methodName: "WordlistRemoveWordsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWordlistRemoveWordsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWordlistRemoveWordsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ModerationAPI.WordlistRemoveWordsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.WordlistRemoveWordsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ModerationAPI.WordlistRemoveWordsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
