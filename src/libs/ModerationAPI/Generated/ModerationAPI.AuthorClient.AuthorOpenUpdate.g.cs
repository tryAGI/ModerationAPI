...
namespace ModerationAPI
{
    public partial class AuthorClient
    {
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement s_AuthorOpenUpdateSecurityRequirement0 =
        ...
        private static readonly global::ModerationAPI.EndPointSecurityRequirement[] s_AuthorOpenUpdateSecurityRequirements =
            new global::ModerationAPI.EndPointSecurityRequirement[]
            {                s_AuthorOpenUpdateSecurityRequirement0,
            };
        partial void PrepareAuthorOpenUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::ModerationAPI.AuthorOpenUpdateRequest request);
        partial void PrepareAuthorOpenUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::ModerationAPI.AuthorOpenUpdateRequest request);
        partial void ProcessAuthorOpenUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAuthorOpenUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await AuthorOpenUpdateAsResponseAsync(
                id: id,
        ...
        /// Console.WriteLine(author);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::ModerationAPI.AutoSDKHttpResponse<global::ModerationAPI.PublicAuthor>> AuthorOpenUpdateAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAuthorOpenUpdateArguments(
            ...
            var __authorizations = global::ModerationAPI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthorOpenUpdateSecurityRequirements,
                operationName: "AuthorOpenUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthorOpenUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ModerationAPI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthorOpenUpdate",
                                methodName: "AuthorOpenUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthorOpenUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ModerationAPI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAuthorOpenUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::ModerationAPI.PublicAuthor> AuthorOpenUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ModerationAPI.AuthorOpenUpdateRequest
            {
            ...
            return await AuthorOpenUpdateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
