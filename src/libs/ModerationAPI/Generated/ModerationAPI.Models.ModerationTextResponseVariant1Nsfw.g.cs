...
namespace ModerationAPI
{
    ...
    public sealed partial class ModerationTextResponseVariant1Nsfw
    {
        ...
        public global::ModerationAPI.ModerationTextResponseVariant1NsfwLabelScores? LabelScores { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModerationTextResponseVariant1Nsfw" /> class.
        /// </summary>
        /// <param name="label">
        /// The label of the model
        /// </param>
...
#endif
        public ModerationTextResponseVariant1Nsfw(
            string? label,
            double? score,
            string? error,
            string? warning,
            global::ModerationAPI.ModerationTextResponseVariant1NsfwLabelScores? labelScores)
        {
            this.Label = label;
            this.Score = score;
            this.Error = error;
